...
export default function Footer() {
    return (
        <footer className="flex justify-center items-center h-fit bg-slate-500 text-white w-screen">
            <div className="grid grid-cols-12  ">
                <div className="flex flex-col items-center ml-5" />
                <div className="flex flex-col items-center mt-2 w-max">
                    <p>© 2024 Property App</p>
                    <p>Developed by Teo Ramos Kees</p>
                </div>
                <div className="flex flex-col items-center mt-6" />
                <div className="flex flex-col items-center mt-6 w-max" />
                <div className="flex flex-col items-center mt-6 w-max" />
                <div className="flex flex-col items-center mt-6 w-max" />
                <div className="flex flex-col items-center mt-6 w-max" />
                <div className="flex flex-col items-center mt-6 w-max" />
